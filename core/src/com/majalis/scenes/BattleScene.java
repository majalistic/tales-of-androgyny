...
public class BattleScene extends Scene {
	...
	public BattleScene(OrderedMap<Integer, Scene> sceneBranches, SaveService saveService, int battleCode, Stance playerStance, Stance enemyStance, ObjectMap<String, Integer> outcomes) {
	...
	public void setActive() {
		isActive = true;
		saveService.saveDataValue(SaveEnum.BATTLE_CODE, new BattleCode(battleCode, outcomes, playerStance, enemyStance));
