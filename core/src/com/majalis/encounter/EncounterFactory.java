	...
	public Encounter getEncounter(EncounterCode encounterCode, BitmapFont font) {
		...
		switch (encounterCode) {
			default: return
					...
					|| encounterCode == EncounterCode.DEFAULT || encounterCode == EncounterCode.TOWN_STORY || encounterCode == EncounterCode.MERI_COTTAGE || encounterCode == EncounterCode.MERI_COTTAGE_VISIT
					? 
