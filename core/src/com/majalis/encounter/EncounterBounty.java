...
public class EncounterBounty {
	...
	public EncounterBountyResult execute(int scoutingScore, SaveService saveService) {
		switch (type) {
			...
			case SOLICITATION: return new EncounterBountyResult("\"Hey, down for a womp?\" says the strange man, offering you some gold.  Do you take a womp?", new Array<MutationResult>(), AssetEnum.CLICK_SOUND.getSound());
			default: return null;
		}
	}
