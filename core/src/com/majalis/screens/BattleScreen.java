...
public class BattleScreen extends AbstractScreen{
	...
	static {
		...
		AssetEnum[] assets = new AssetEnum[]{
			...
			NULL, ANAL, BLITZ, BALANCED, CASTING, COUNTER, DEFENSIVE, DOGGY, ERUPT, FELLATIO, FULL_NELSON, KNEELING, HANDY, ITEM, COWGIRL, OFFENSIVE, OUROBOROS, FACEFUCK, PRONE, SUPINE, STANDING, AIRBORNE, FACE_SITTING, SIXTY_NINE, KNOTTED, SPREAD, PENETRATED, PRONEBONE, REVERSE_COWGIRL,
