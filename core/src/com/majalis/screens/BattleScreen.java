...
public class BattleScreen extends AbstractScreen{
	...
	static {
		...
		AssetEnum[] assets = new AssetEnum[]{
			NULL, SLASH, BATTLE_HOVER, BATTLE_TEXTBOX, BATTLE_UI, BLEED, ARMOR_0, ARMOR_1, HEART, ELF, SEARCHING,
			...
			MARS_ICON_0, MARS_ICON_1, MARS_ICON_2, MARS_ICON_3, MARS_ICON_4, SMALL_DONG_0, SMALL_DONG_1, SMALL_DONG_2, SMALL_DONG_CHASTITY, ARMOR_DOLL
		};
