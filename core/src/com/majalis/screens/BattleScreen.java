...
public class BattleScreen extends AbstractScreen{
	...
	static {
		...
		AssetEnum[] assets = new AssetEnum[]{
			...
			NULL_STANCE, ANAL, BLITZ, BALANCED, CASTING, COUNTER, DEFENSIVE, DOGGY, ERUPT, FELLATIO, FULL_NELSON, GROUND_WRESTLE, KNEELING, HANDS_AND_KNEES,  HANDY, ITEM, COWGIRL, OFFENSIVE, OUROBOROS, FACEFUCK, PRONE, SUPINE, STANDING, AIRBORNE, FACE_SITTING, SIXTY_NINE, KNOTTED, SPREAD, PENETRATED, PRONEBONE, REVERSE_COWGIRL,
			...
			MARS_ICON_0, MARS_ICON_1, MARS_ICON_2, MARS_ICON_3, MARS_ICON_4, SMALL_DONG_0, SMALL_DONG_1, SMALL_DONG_2, SMALL_DONG_CHASTITY, STUFFED_BELLY, FULL_BELLY, BIG_BELLY, FLAT_BELLY, 
		};
