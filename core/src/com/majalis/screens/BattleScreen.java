...
public class BattleScreen extends AbstractScreen{
	...
	static {
		...
		AssetEnum[] assets = new AssetEnum[]{
			ANAL, BLITZ, BALANCED, DEFENSIVE, DOGGY, ERUPT, FELLATIO, FULL_NELSON, KNEELING, HANDY, ITEM, COWGIRL,
			OFFENSIVE, PRONE, SUPINE, STANDING, AIRBORNE, CASTING, FACE_SITTING, SIXTY_NINE, KNOTTED, 
			SLASH,  BATTLE_HOVER, BATTLE_TEXTBOX, BATTLE_UI, 
			...
			HEALTH_ICON_0, STAMINA_ICON_0, BALANCE_ICON_0, MANA_ICON_0,
			...
			SMALL_DONG_0, SMALL_DONG_1, SMALL_DONG_2, ARMOR
