...
public class BattleScreen extends AbstractScreen{
	...
	static {
		...
		String[] textureArray = new String[]{
			"WerebitchChibi.png", AssetEnum.BATTLE_BG.getPath(), AssetEnum.WEREBITCH.getPath(), AssetEnum.HARPY.getPath(), AssetEnum.SLIME.getPath(), AssetEnum.BRIGAND.getPath(), AssetEnum.ANAL.getPath(), AssetEnum.BLITZ.getPath(),
