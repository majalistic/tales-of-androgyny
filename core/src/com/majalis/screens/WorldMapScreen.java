...
public class WorldMapScreen extends AbstractScreen {
	...
	static {
		...
		AssetEnum[] assets = new AssetEnum[]{
			...
			GROUND_SHEET, DOODADS, TREE_CLUSTER_1, TREE_CLUSTER_2, WORLD_MAP_BG, CHARACTER_ANIMATION, MOUNTAIN_ACTIVE, FOREST_ACTIVE, FOREST_INACTIVE, CASTLE, TOWN, COTTAGE, APPLE, MEAT, CLOUD, CLOUD_2, CLOUD_3, CLOUD_4, CLOUD_5, ROAD_TILES, WORLD_MAP_UI, WORLD_MAP_HOVER, ARROW, CHARACTER_SCREEN, EXP, GOLD, TIME, HEART, SEARCHING, STEALTH, NULL
		};
