...
public class ScreenFactoryImpl implements ScreenFactory {
	...
	public AbstractScreen getScreen(ScreenEnum screenRequest) {
        ...
        font = new BitmapFont(Gdx.files.internal("fonts/Solstice18/solstice.fnt"), Gdx.files.internal("fonts/Solstice18/solstice.png" ), false);
		...
		switch (context){
			...
			case WORLD_MAP: 
				if (getAssetCheck(GameScreen.resourceRequirements)){
					...
					return new GameScreen(this, elements, assetManager, loadService, gameWorldFactory.getGameWorld((OrthographicCamera)elements.getViewport().getCamera(), worldSeed));
				}
				else return null;
			case BATTLE:
