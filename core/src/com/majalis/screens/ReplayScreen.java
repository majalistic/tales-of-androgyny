...
public class ReplayScreen extends AbstractScreen {
	...
	static {
		...
		Array<AssetEnum> animationReqs = new Array<AssetEnum>(new AssetEnum[]{
			HARPY_ANIMATION, HARPY_ATTACK_ANIMATION, FEATHERS_ANIMATION, FEATHERS2_ANIMATION, BRIGAND_ANIMATION, ANAL_ANIMATION, CENTAUR_ANIMATION, ORC_ANIMATION, WEREWOLF_ANIMATION, GOBLIN_ANIMATION, ORC_PRONE_BONE_ANIMATION, BEASTMISTRESS_ANIMATION		
		});
