...
public class ReplayScreen extends AbstractScreen {
	...
	static {
		...
		for (AssetEnum asset : new AssetEnum[] { CAMP_BG0, CAMP_BG1, CAMP_BG2, NULL, OGRE_BANGED, BUNNY_CARAMEL_ANAL, BUNNY_VANILLA_ANAL, BUNNY_CHOCOLATE_ANAL, BUNNY_DARK_CHOCOLATE_ANAL, BUNNY_CREAM_ANAL,
		WEREBITCH_KNOT_CUM, CENTAUR_GANGBANG, BEASTMISTRESS_KITTY_ANAL, BEASTMISTRESS_KITTY_ANAL_INTERNAL, BEASTMISTRESS_KITTY_ANAL_INTERNAL_CUM, WARLOCK_ANAL}) {
			resourceRequirements.add(asset.getTexture());
		}
		for (AssetEnum asset: new AssetEnum[]{ HARPY_ANIMATION, HARPY_ATTACK_ANIMATION, FEATHERS_ANIMATION, FEATHERS2_ANIMATION, BRIGAND_ANIMATION, ANAL_ANIMATION, CENTAUR_ANIMATION, ORC_ANIMATION, WEREWOLF_ANIMATION, GOBLIN_ANIMATION, ORC_PRONE_BONE_ANIMATION, BEASTMISTRESS_ANIMATION,
		GHOST_ANIMATION, TRUDY_SPRITE_ANIMATION, BUNNY_ANIMATION}) {
