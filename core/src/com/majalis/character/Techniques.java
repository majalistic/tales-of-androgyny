...
public enum Techniques {
	...
	TEMPO_ATTACK  	{ public Stance getStanceResult(){ return Stance.OFFENSIVE; } public int getPowerMod(){ return 2; } public int getStabilityCost(){ return 2; } public int getStaminaCost(){ return 4; } },
	SPRING_ATTACK 	{ public Stance getStanceResult(){ return Stance.OFFENSIVE; } public int getPowerMod(){ return 1; } public int getStabilityCost(){ return 3; } public int getStaminaCost(){ return 2; } },	
	/* Balanced Techniques */
	RESERVED_ATTACK { public Stance getStanceResult(){ return Stance.BALANCED;  } public int getPowerMod(){ return 1; } public int getStabilityCost(){ return 1; } public int getStaminaCost(){ return 2; } },
	...
	CAREFUL_ATTACK  { public Stance getStanceResult(){ return Stance.DEFENSIVE; } public int getPowerMod(){ return 0; }  public int getStabilityCost(){ return 0; } public int getStaminaCost(){ return 1; } }, 
