	...
	public Array<AssetDescriptor<AnimatedActorFactory>> getAnimationRequirements() {
		...
		switch (this) {
			...
			case CENTAUR:
				...
				break;
			case GHOST:
				temp.add(AssetEnum.GHOST_ANIMATION.getAnimation());
				break;
			case GOBLIN:
			case GOBLIN_MALE:
		...
		switch (this) {
			...
			case UNICORN:
				return new Array<MutationResult>(new MutationResult[]{
						new MutationResult("The flared head of " + pronouns.getPossessive() + " horsecock penetrates your asshole!"),
						new MutationResult("Your hole is stretched wide by " + pronouns.getPossessive() + " tremendous dick!"),
						new MutationResult("Your hole feels like it's on fire!"),
						new MutationResult(properCase(pronouns.getPossessive()) + " horsecock glides smoothly through your irritated anal mucosa!"),
			...
			case HARPY:
				return new Array<MutationResult>(new MutationResult[]{
						new MutationResult("You are being stuffed up the butt!"),
						new MutationResult("Your hole is stretched by " + pronouns.getPossessive() + " smooth bird dick!"),
						new MutationResult("Your hole feels like it's on fire!"),
						new MutationResult(properCase(pronouns.getPossessive()) + " dick glides smoothly through your irritated anal mucosa!"),
						new MutationResult(properCase(pronouns.getPossessive()) + " rhythmic thrusting in and out of your asshole is emasculating!"),
						new MutationResult("You are red-faced and embarassed because of " + pronouns.getPossessive() + " feathery butt-stuffing!"),
						new MutationResult("Your cock is ignored!")
				});
			case GOBLIN:
				return new Array<MutationResult>(new MutationResult[]{
						new MutationResult("You are being butt-pounded by a goblin!"),
						new MutationResult("Your hole is stretched by " + pronouns.getPossessive() + " knobbly dick!"),
						new MutationResult("Your hole feels like it's on fire!"),
						new MutationResult(properCase(pronouns.getPossessive()) + " dick grinds against your anal mucosa!"),
						new MutationResult(properCase(pronouns.getPossessive()) + " rhythmic thrusting in and out of your asshole is emasculating!"),
