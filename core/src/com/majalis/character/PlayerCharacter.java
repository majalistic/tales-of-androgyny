...
public class PlayerCharacter extends AbstractCharacter {
	...
	private static ObjectSet<Techniques> getBaseTechniques() {
		...
		baseTechniques.addAll(
			...
			RECEIVE_ANAL, RECEIVE_DOGGY, RECEIVE_STANDING, STRUGGLE_ORAL, STRUGGLE_DOGGY, STRUGGLE_ANAL, STRUGGLE_STANDING, RECEIVE_KNOT, SUCK_KNOT, SUCK_IT, BLOW, BREAK_FREE_ANAL, BREAK_FREE_ORAL,
			SUBMIT, STRUGGLE_FULL_NELSON, BREAK_FREE_FULL_NELSON, STRUGGLE_PRONE_BONE, STRUGGLE_DOGGY,
			OPEN_WIDE, GRAB_IT, STROKE_IT, FONDLE_BALLS, KISS_IT, KISS_BALLS, SPIT_ON_IT, OPEN_UP, LET_GO, USE_ITEM, ITEM_OR_CANCEL, 
