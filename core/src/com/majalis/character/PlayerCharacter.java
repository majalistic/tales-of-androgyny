...
public class PlayerCharacter extends AbstractCharacter {
	...
	private static ObjectSet<Techniques> getBaseTechniques() {
		...
		baseTechniques.addAll(
			...
			RECEIVE_ANAL, RECEIVE_DOGGY, SPREAD_DOGGY, PUSH_BACK_DOGGY, RECEIVE_STANDING, STRUGGLE_ORAL, STRUGGLE_DOGGY, STRUGGLE_ANAL, STRUGGLE_STANDING, RECEIVE_KNOT, SUCK_KNOT, SUCK_IT, SUCK_AND_STROKE, SUCK_AND_BEAT, BLOW, BREAK_FREE_ANAL, BREAK_FREE_ORAL,
	...
	public float getPercentToLevel() {
		...
		while (currentExperience >= 0) {
			...
			int experienceForLevel = (1 + (currentLevel / 10)) * 10;
	...
	public boolean hasKyliraHeal() { boolean temp = kyliraHeal; if (getKyliraLevel() > 0) kyliraHeal = false; return temp && hasKylira(); }
