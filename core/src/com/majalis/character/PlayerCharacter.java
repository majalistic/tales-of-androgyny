...
public class PlayerCharacter extends AbstractCharacter {
	...
	private static ObjectSet<Techniques> getBaseTechniques() {
		...
		baseTechniques.addAll(
			DO_NOTHING, POWER_ATTACK, TEMPO_ATTACK, RESERVED_ATTACK, DUCK, SPRING_ATTACK, NEUTRAL_ATTACK, REVERSAL_ATTACK, CAREFUL_ATTACK, BLOCK, GUARD, KICK_OVER_FACE_UP, KICK_OVER_FACE_DOWN, ABSOLUTE_GUARD, LOWER_GUARD, RAGE,
