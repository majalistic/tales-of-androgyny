...
public abstract class AbstractCharacter extends Group {
	...
	protected Array<Techniques> getHypnotizedTechniqueOptions(AbstractCharacter target) {
		...
		switch(stance) {
			...
			case HANDY_BOTTOM: return getTechniques(target, STROKE_IT, KISS_IT, KISS_BALLS, OPEN_UP, OPEN_WIDE);
	...
	protected Array<Techniques> getDefaultTechniqueOptions(AbstractCharacter target) {
		...
		switch(stance) {
			...
			case HANDY_BOTTOM: return getTechniques(target, STROKE_IT, KISS_IT, KISS_BALLS, OPEN_UP, OPEN_WIDE, LET_GO);
