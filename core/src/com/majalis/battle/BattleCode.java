...
public enum BattleCode {
	...
	BRIGAND (BRIGAND_ORAL, FOREST_BG, LARGE_DONG_0, LARGE_DONG_1, LARGE_DONG_2),
	CENTAUR (CENTAUR_ANAL, CENTAUR_ANAL_XRAY, PLAINS_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	UNICORN (PLAINS_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	GOBLIN (AssetEnum.CARNIVAL_MUSIC.getMusic(), AssetEnum.GOBLIN, GOBLIN_FACE_SIT, ENCHANTED_FOREST_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	GOBLIN_STORY (AssetEnum.CARNIVAL_MUSIC.getMusic(), AssetEnum.GOBLIN, GOBLIN_FACE_SIT, ENCHANTED_FOREST_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	GOBLIN_MALE (AssetEnum.CARNIVAL_MUSIC.getMusic(), AssetEnum.GOBLIN_MALE, ENCHANTED_FOREST_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
