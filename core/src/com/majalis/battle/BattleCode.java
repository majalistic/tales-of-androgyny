...
public enum BattleCode {
	...
	WERESLUT (EnemyEnum.WERESLUT, WEREBITCH_ANAL, WEREBITCH_KNOT, FOREST_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	...
	GOBLIN (AssetEnum.CARNIVAL_MUSIC, EnemyEnum.GOBLIN, GOBLIN_ANAL, GOBLIN_FACE_SIT, ENCHANTED_FOREST_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	GOBLIN_STORY (AssetEnum.CARNIVAL_MUSIC, EnemyEnum.GOBLIN, GOBLIN_ANAL, GOBLIN_FACE_SIT, ENCHANTED_FOREST_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	GOBLIN_MALE (AssetEnum.CARNIVAL_MUSIC, EnemyEnum.GOBLIN_MALE, GOBLIN_ANAL_MALE, GOBLIN_FACE_SIT_MALE, ENCHANTED_FOREST_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	ORC (AssetEnum.BOSS_MUSIC, EnemyEnum.ORC, FOREST_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	ORC_STORY (AssetEnum.BOSS_MUSIC, EnemyEnum.ORC, FOREST_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	...
	NAGA(AssetEnum.HEAVY_MUSIC, EnemyEnum.NAGA, AssetEnum.NAGA, CAVE_BG, NAGA_ANAL, NAGA_ANAL_CUM, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2), 
	QUETZAL(AssetEnum.BOSS_MUSIC, EnemyEnum.QUETZAL, AssetEnum.QUETZAL, QUETZAL_BG, MONSTER_DONG_0, MONSTER_DONG_1, MONSTER_DONG_2),
	MERMAID(AssetEnum.HEAVY_MUSIC, EnemyEnum.MERMAID, AssetEnum.MERMAID, WATERFALL_BG),
	WARLOCK(AssetEnum.HORROR_MUSIC, EnemyEnum.WARLOCK, AssetEnum.WARLOCK, AssetEnum.WARLOCK_BG, LARGE_DONG_0, LARGE_DONG_1, LARGE_DONG_2)
	;
