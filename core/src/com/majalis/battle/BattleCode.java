...
public enum BattleCode {
	...
	GHOST (AssetEnum.HORROR_MUSIC, EnemyEnum.GHOST, FOREST_BG), 
	BUNNY(AssetEnum.BOSS_MUSIC, EnemyEnum.BUNNY, FOREST_BG), 
	...
	DULLAHAN(EnemyEnum.DULLAHAN, AssetEnum.DULLAHAN, FOREST_BG), 
	;
